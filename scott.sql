...
--INCREMENT BY 1 (기본값 1, 증가를 얼마씩 할 것인지) 
...
--CREATE SYNONYM 동의어 이름 FOR 테이블명
...
--	3) PRIMARY KEY : 지정한 열이 유일한 값이면서 NULL을 허용하지 않음(테이블당 하나만 지정 가능)
...
INSERT INTO TABLE_NOTNULL VALUES ('TEST_ID_01', NULL, '010-1234-1234');
INSERT INTO TABLE_NOTNULL VALUES ('TEST_ID_01', 'TEST_PW_01', NULL);

-- ("SCOTT"."TABLE_NOTNULL"."LOGIN_PWD")을 업데이트할 수 없습니다
...
INSERT INTO TABLE_UNIQUE VALUES('TEST_ID_01', 'TEST_PW_01', '010-1234-1234');
...
INSERT INTO TABLE_UNIQUE VALUES(NULL, 'TEST_PW_01', '010-1234-1234');
...
INSERT INTO TABLE_PK VALUES('TEST_ID_01', 'TEST_PW_01', '010-1234-1234');
...
-- DEPT 테이블의 DEPTNO값을 기반으로 EMP테이블의 DEPTNO값 삽입
INSERT INTO EMP VALUES(9999, 'TEST', 'CLERK', '7788', '2017-04-30', 1200, NULL, 50);
...
INSERT INTO EMP_FK VALUES(9999, 'TEST', 'CLERK', '788', '2017-04-30', 1200, NULL, 50);
...
CREATE TABLE TABLE_CHECK(
	LOGIN_ID VARCHAR2(20) PRIMARY KEY,
	LOGIN_PWD VARCHAR2(20) CONSTRAINT TBLCK_LGNPW_CK CHECK(LENGTH(LOGIN_PWD) >= 3), -- 길이 3이상
	TEL VARCHAR2(20)
);
...
-- BOARD 테이블 정의
-- BNO(NUMBER), NAME, PASSWORD, TITLE, CONTENT, READCNT(NUMBER-DEFAULT-0), REGDATE(DATE-DEFAULT-SYSDATE)
-- PRIMARY KEY : BNO
-- NOT NULL : NAME, PASSWORD, TITLE CONTENT
-- SEQUENCE : 1씩 증가 BOARD_SEQ
...
VALUES(BOARD_SEQ.NEXTVAL, 'HONG', '1111', '게시글 제목', '게시글 내용');
